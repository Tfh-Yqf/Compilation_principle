...
public class SyntaxAnanlyzer {
    ...
    public SyntaxAnanlyzer() {
        try {
            output = new BufferedWriter(new FileWriter("C:\\Users\\谭福华\\Desktop\\CompilePrinciple-master\\src\\GrammarAnalysis\\output.txt"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void getText() {
        ...
        try {
            bufferedReader = new BufferedReader(new FileReader("C:\\Users\\谭福华\\Desktop\\CompilePrinciple-master\\src\\GrammarAnalysis\\input.txt"));
            String lString;
